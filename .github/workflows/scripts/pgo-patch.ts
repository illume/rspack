...
export interface PatchPlanCrate {
	crate: string;
	/** Path the `[patch.crates-io]` entry should point at, relative to the workspace root. */
	patchPath: string;
...
export function renderCargoPatchSection(plan: PatchPlan): string {
	...
	lines.push(
		`# Generated by pgo-patch.ts; ${plan.crates.length} third-party crate(s)`
	);
	lines.push(
